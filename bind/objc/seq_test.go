...
func TestObjcSeqTest(t *testing.T) {
	runTest(t, []string{
		"github.com/bilb02/go-mobile/bind/testdata/testpkg",
		"github.com/bilb02/go-mobile/bind/testdata/testpkg/secondpkg",
		"github.com/bilb02/go-mobile/bind/testdata/testpkg/simplepkg",
...
func TestObjcSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/bilb02/go-mobile/bind/testdata/benchmark"}, "", "SeqBench.m", "Benchmark.framework", true, true)
}

// TestObjcSeqWrappers runs ObjC test SeqWrappers.m.
func TestObjcSeqWrappers(t *testing.T) {
	runTest(t, []string{"github.com/bilb02/go-mobile/bind/testdata/testpkg/objcpkg"}, "", "SeqWrappers.m", "Objcpkg.framework", false, false)
}

// TestObjcCustomPkg runs the ObjC test SeqCustom.m.
func TestObjcCustomPkg(t *testing.T) {
	runTest(t, []string{"github.com/bilb02/go-mobile/bind/testdata/testpkg"}, "Custom", "SeqCustom.m", "Testpkg.framework", false, false)
}
...
func runTest(t *testing.T, pkgNames []string, prefix, testfile, framework string, uitest, dumpOutput bool) {
	...
	if _, err := run("which gomobile"); err != nil {
		...
		if _, err := run("go install github.com/bilb02/go-mobile/cmd/gomobile"); err != nil {
