...
func testMain(m *testing.M) int {
	...
	if runtime.GOOS != "android" {
		...
		if out, err := exec.Command("go", "build", "-o", gomobileBin, "github.com/bilb02/go-mobile/cmd/gomobile").CombinedOutput(); err != nil {
			log.Fatalf("gomobile build failed: %v: %s", err, out)
		}
		if out, err := exec.Command("go", "build", "-o", gobindBin, "github.com/bilb02/go-mobile/cmd/gobind").CombinedOutput(); err != nil {
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/bilb02/go-mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/bilb02/go-mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
