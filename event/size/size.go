...
//
// See the github.com/bilb02/go-mobile/app package for details on the event model.
package size // import "github.com/bilb02/go-mobile/event/size"
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/bilb02/go-mobile/geom package.
	//
