...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/bilb02/go-mobile/example/basic"})
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/bilb02/go-mobile", "github.com/bilb02/go-mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/bilb02/go-mobile", "github.com/bilb02/go-mobile", 2},
		{"ffffffff t github.com/example/github.com/bilb02/go-mobile", "", 0},
