...
var tests = []struct {
	...
	{"ObjC-Testpkg", "objc", "github.com/bilb02/go-mobile/bind/testdata/testpkg", "", false},
	{"Java-Testpkg", "java", "github.com/bilb02/go-mobile/bind/testdata/testpkg", "", false},
	{"Go-Testpkg", "go", "github.com/bilb02/go-mobile/bind/testdata/testpkg", "", false},
	{"Java-Javapkg", "java", "github.com/bilb02/go-mobile/bind/testdata/testpkg/javapkg", "android", true},
	{"Go-Javapkg", "go", "github.com/bilb02/go-mobile/bind/testdata/testpkg/javapkg", "android", true},
	{"Go-Javapkg", "go,java,objc", "github.com/bilb02/go-mobile/bind/testdata/cgopkg", "android", false},
}
...
func testMain(m *testing.M) int {
	...
	if runtime.GOOS != "android" {
		if out, err := exec.Command("go", "build", "-o", bin.Name(), "github.com/bilb02/go-mobile/cmd/gobind").CombinedOutput(); err != nil {
